...
def seed_tags(session: Session, users: dict) -> list[Tag]:
    ...
    tags_data = [
        {"name": "performance", "description": "Características relacionadas con rendimiento"},
...
def seed_resources(session: Session, users: dict) -> list[Resource]:
    ...
    for resource_data in resources_data:
        ...
        if existing:
            logger.info(f"  ℹ️  Recurso '{resource_data['title']}' ya existe, omitiendo...")
...
def seed_feature_models(
    ...
    # Sub-features
    features_data = [
        {"name": "Product Catalog", "type": FeatureType.MANDATORY, "parent": root_feature},
        {"name": "Shopping Cart", "type": FeatureType.MANDATORY, "parent": root_feature},
        {"name": "Payment Processing", "type": FeatureType.MANDATORY, "parent": root_feature},
        {"name": "User Management", "type": FeatureType.MANDATORY, "parent": root_feature},
        {"name": "Wishlist", "type": FeatureType.OPTIONAL, "parent": root_feature},
        {"name": "Product Reviews", "type": FeatureType.OPTIONAL, "parent": root_feature},
        {"name": "Recommendations", "type": FeatureType.OPTIONAL, "parent": root_feature},
    ]
